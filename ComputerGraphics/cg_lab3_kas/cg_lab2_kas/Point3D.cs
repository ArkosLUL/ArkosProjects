...
namespace cg_lab2_kas
{
    class Point3D
    {
        ...
        public static List<PointF> _2DPoints = new List<PointF>();
        ...
        public static void DeepCopyFor2DPoints()
        {
            for (int i = 0; i < pointsDefault.Count; i++)
            {
                pointsToDraw.Add(new Point3D(pointsDefault[i].x, pointsDefault[i].y, pointsDefault[i].z));
            }
        }
        ...
        public static void ConvertTo2DPoints()
        {
            _2DPoints.Clear();
        ...
        public static void GetZ()
        {
            ...
            {
                if (tr.A < points.Count && tr.B < points.Count && tr.C < points.Count)
                    tr.Z = (float)(points[tr.A].z + points[tr.B].z + points[tr.C].z) / 3;
            }
        }
