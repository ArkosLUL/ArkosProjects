...
namespace kas_csharp_lr_4
{
    ...
    public class Copywriter : Person, IDateAndCopy, INotifyPropertyChanged
    {
        ...
        public string Nickname
        {
            ...
            set
            {
                ...
                {
                    PropertyChangedEventArgs e = new PropertyChangedEventArgs("Nickname");
        ...
        public int Rating
        {
            ...
            set
            {
                ...
                if (PropertyChanged != null)
                {
                    PropertyChangedEventArgs e = new PropertyChangedEventArgs("Rating");
                    PropertyChanged(this, e);
                }
            }
        }
        ...
        public int AverageQuantityOfSings
        {
            get
            {
                int sum = 0;
